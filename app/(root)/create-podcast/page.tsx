...
const CreatePodcast = () => {
  ...
  const formSchema = z.object({
    ...
    podcastDescription: z.string().min(2).max(100)
  })
  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    try {
      ...
      if (!audioUrl || !imageUrl || !voiceType) {
        toast({
          title: "Please generate audio and image before submitting the form!",
          variant: "destructive",
        });
        setIsSubmitting(false);
        throw new Error("Please generate audio and image before submitting the form!");
      }
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='flex flex-col gap-2.5'>
                  ...
                  <FormControl>
                    <Input className='input-class focus-visible:ring-offset-orange-1' placeholder="Phoenix Pro Podcast" {...field} />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='flex flex-col gap-2.5'>
                  ...
                  <FormControl>
                    <Textarea rows={3} className='input-class focus-visible:ring-offset-orange-1' placeholder="Write a short Podcast Description" {...field} />
                  </FormControl>
                  <FormMessage className='text-white-1' />
                </FormItem>
              )}
